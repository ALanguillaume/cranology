...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Explore CRAN history",
    Description = "Explore CRAN packages number by date.",
    `Authors@R` = c(
      person("Antoine", "Languillaume", email = "antoine@thinkr.fr", role = c("aut", "cre"), comment = c(ORCID = "0000-0002-1565-9313"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Antoine Languillaume")
# usethis::use_proprietary_license("WUR")
```
